 ...
 * @version 1.0.0
 * @since 2014年11月20日 上午12:34:39
 */
public class SSLServer {
	private static final int DEFAULT_PORT = 7777;

	private static final String SERVER_KEY_STORE_PASSWORD = "lF0130lf";
	private static final String SERVER_TRUST_KEY_STORE_PASSWORD = "lF0130lf";
	...
	public void init() {
		try {
			...
			ks.load(new FileInputStream("F://dev/java-ssl/kserver.keystore"), SERVER_KEY_STORE_PASSWORD.toCharArray());
			tks.load(new FileInputStream("F://dev/java-ssl/tserver.keystore"),
