...
/**
 * This example server aims to demonstrate <a
 * href="http://www.w3.org/TR/cors/">Cross Origin Resource Sharing</a> (CORS) in
 * Netty. It does not have a client like most of the other examples, but instead
 * has a html page that is loaded to try out CORS support in a web brower.
 * <p>
 * 
 * CORS is configured in {@link HttpServerInitializer} and by updating the
 ...
 * 
 * <h2>Testing CORS</h2>
 * You can either load the file {@code src/main/resources/cors/cors.html} using
 * a web server or load it from the file system using a web browser.
 * 
 * <h3>Using a web server</h3>
 * To test CORS support you can serve the file
 ...
 * Open the file {@code src/main/resources/cors/cors.html} in a web browser. You
 * should see loaded page and in the text area the following message:
 * 
 * <pre>
 * 'CORS is not working'
 * </pre>
